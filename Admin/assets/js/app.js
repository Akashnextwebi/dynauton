!(function () {
                ...
                (e < 1025 && 767 < e
                    ...
                    : 1025 <= e
                        ? (document.body.classList.remove("twocolumn-panel"),
                            ...
                            document.querySelector(".hamburger-icon") && (getCookieValue("dyn_tray") == "closed" ? document.querySelector(".hamburger-icon").classList.add("open") : document.querySelector(".hamburger-icon").classList.remove("open")))
                        : e <= 767 &&
    ...
    function w() {
        ...
        767 < e && document.querySelector(".hamburger-icon").classList.toggle("open"),
            ...
            (e < 1025 && 767 < e ? (document.body.classList.remove("vertical-sidebar-enable"),
                "sm" == document.documentElement.getAttribute("data-sidebar-size") ? document.documentElement.setAttribute("data-sidebar-size", "") : document.documentElement.setAttribute("data-sidebar-size", "sm"), document.cookie = "dyn_tray=closed")
                : 1025 < e ? (document.body.classList.remove("vertical-sidebar-enable"),
                    "lg" == document.documentElement.getAttribute("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), document.cookie = "dyn_tray=closed") : (document.documentElement.setAttribute("data-sidebar-size", "lg"), document.cookie = "dyn_tray=open"))
                    : e <= 767 && (document.body.classList.add("vertical-sidebar-enable"), document.documentElement.setAttribute("data-sidebar-size", "lg"), document.cookie = "dyn_tray=open")),
    ...
    function F(e, t, a, o) {
        if (t == "dark") {
            document.cookie = "dyn_theme=dark"
        }
        else {
            document.cookie = "dyn_theme=light"
        }
