...
public partial class Admin_view_blogs : System.Web.UI.Page
{
    ...
    SqlConnection conPN = new SqlConnection(ConfigurationManager.ConnectionStrings["conPN"].ConnectionString);
    ...
    public void GetAllDetails()
    {
        ...
        {
            strBlogs = "";
            List<BlogDetails> BD = BlogDetails.GetAllBlogDetails(conPN);
    ...
    public static string Delete(string id)
    {
        ...
        try
        {
            ...
            int exec = BlogDetails.DeleteBlogDetails(conPN, BD);
            if (exec > 0)
            {
                x = "Success";
            }
