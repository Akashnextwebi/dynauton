<%@ Page Title="" Language="C#" MasterPageFile="./user.master" AutoEventWireup="true" CodeFile="my-account-address.aspx.cs" Inherits="my_account_address" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      ...
      .new-active3 {
          ...
          color: #ff0000;
              ...
              .my-account-content.account-address {
    padding: 20px;
    background: #f1f1f1;
}
  </style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="my-account-content account-address">
        <div class="text-center widget-inner-address">
            <a class="tf-btn btn-fill animate-hover-btn btn-address mb_20" >Add a new address</a>
            <div class="show-form-address wd-form-address" id="formnewAddress" action="#">
            ...
            <div class="list-account-address">
                <div class="account-address-item">
                    ...
                    <div class="d-flex gap-10 justify-content-center">
                        <a class="tf-btn btn-fill animate-hover-btn justify-content-center btn-edit-address">
                            <span>Edit</span>
                        </a>
                        <a class="tf-btn btn-outline animate-hover-btn justify-content-center">
                            <span>Delete</span>
                        </a>
                    </div>
                    <div class="edit-form-address wd-form-address" id="formeditAddress1" action="#">
    ...
    <div class="d-flex align-items-center justify-content-center gap-20">
        ...
        <span class="tf-btn btn-fill animate-hover-btn btn-hide-edit-address">Cancel</span>
                ...
                <div class="account-address-item">
                    ...
                    <div class="edit-form-address wd-form-address" id="formeditAddress2" action="#">
                        <div class="title">Edit address</div>
                        <div class="box-field grid-2-lg">
                            <div class="tf-field style-1">
                                <input class="tf-field-input tf-input" placeholder=" " type="text" id="firstnameEdit" name="first name">
    ...
    <script>
        document.getElementByClass("btn-address").onclick = function () {
            console.log("Button clicked");
            const formElement = document.getElementById("formnewAddress");
