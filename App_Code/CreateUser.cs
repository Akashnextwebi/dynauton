...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection ConDYN)
    {
        ...
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand(query, ConDYN))
            {
    ...
    public static CreateUser GetUserDetails(SqlConnection ConDYN, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection ConDYN, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection ConDYN, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection ConDYN, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection ConDYN, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection ConDYN, string id,string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection ConDYN, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection ConDYN, CreateUser loginInputs)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand(query, ConDYN);
    ...
    public static CreateUser Login2(SqlConnection ConDYN, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection ConDYN, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection ConDYN, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection ConDYN, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection ConDYN, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection ConDYN, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection ConDYN, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection ConDYN, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection ConDYN, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection ConDYN, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection ConDYN, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection ConDYN, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection ConDYN)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection ConDYN, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(ConDYN, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(ConDYN, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(ConDYN, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(ConDYN, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(ConDYN, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
