...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection ConDYN)
    {
    ...
    public static int InsertPageGroup(SqlConnection ConDYN, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection ConDYN, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection ConDYN, PageGroup cat)
    {
        int result = 0;
