...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection ConDYN)
    {
    ...
    public static int InsertPageMaster(SqlConnection ConDYN, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection ConDYN, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection ConDYN, PageMaster cat)
    {
        int result = 0;
