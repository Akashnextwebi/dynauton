...
public class DashBoard
{
    ...
    /// </summary>
    /// <param name="ConDYN">DB connection</param>
    /// <returns>All list</returns>


    public static decimal GetTotalSales(SqlConnection ConDYN)
    {
        decimal x = 0;
        try
        {
    ...
    public static int GetOrderCount(SqlConnection ConDYN)
    {
        int x = 0;
        try
        {
    ...
    public static int GetCustomerCount(SqlConnection ConDYN)
    {
        int x = 0;
        try
        {
    ...
    public static int GetCustomerCountbyAguid(SqlConnection ConDYN)
    {
        int x = 0;
        try
        {
    ...
    public static int GetArchitectCount(SqlConnection ConDYN)
    {
        int x = 0;
        try
        {
    ...
    public static decimal NoOfContacts(SqlConnection ConDYN)
    {
        decimal x = 0;
        try
        {
    ...
    public static decimal TodaysOrder(SqlConnection ConDYN, string tDay)
    {
        decimal x = 0;
        try
        {
    ...
    public static decimal MonthsOrder(SqlConnection ConDYN, string mnth, string yr)
    {
        decimal x = 0;
        try
        {
