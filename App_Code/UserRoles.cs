...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection ConDYN)
    {
    ...
    public static int InsertUserRoles(SqlConnection ConDYN, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection ConDYN, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection ConDYN, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection ConDYN, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection ConDYN, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection ConDYN, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection ConDYN, UserRolesAccess cat)
    {
        int result = 0;
