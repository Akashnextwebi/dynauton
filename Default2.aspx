...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="container">
                                <div class="home-slider-content">
                                    <h1 class="fade-item fade-item-2">Securing Nations with  <br /> <span>Sky-High Intelligence</span></h1>
                                    ...
                                    <img class="lazyload" data-src="imgs/banner-1.png" src="imgs/banner-1.png" alt="fashion-slideshow-01">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
    ...
    <div class="main-marq shadow-off">
        <div class="slide-har st1">
            ...
            <section class="section-padding flat-spacing-11 box-light  wow fadeInUp featured-products" data-wow-delay=".3s">
                                ...
                                <a href="#" class="collection-inner">
                                    ...
                                    <%--<div class="collection-content">
                                        <div class="top wow fadeInUp" data-wow-delay="0s">
                                            <h5 class="heading fw-bold">Drone version 1</h5>
                                            <p class="subheading">Start from <span class="fw-6">₹ 5990*</span></p>
                                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="collection-item-v2 hover-img bor radius-20 ">
                                <a href="#" class="collection-inner">
                                    ...
                                    <%--<div class="collection-content">
                                        <div class="top wow fadeInUp" data-wow-delay="0s">
                                            <h5 class="heading fw-bold">Drone version 2</h5>
                                            <p class="subheading">Start from <span class="fw-6">₹ 5990*</span></p>
                                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="collection-item-v2 hover-img bor radius-20 ">
                                <a href="#" class="collection-inner">
                                    ...
                                    <%--<div class="collection-content">
                                        <div class="top wow fadeInUp" data-wow-delay="0s">
                                            <h5 class="heading fw-bold">Drone version 3</h5>
                                            <p class="subheading">Start from <span class="fw-6">₹ 5990*</span></p>
                                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="custom-section-title wow fadeInUp text-center" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
                            ...
                            <p class="wow fadeInUp text-white" data-wow-delay=".3s">
                                Engineered for precision, durability, and performance. Explore the next frontier of aerospace<br />innovation with our state-of-the-art drone components.
                            </p>
                        </div>
                        <div class="col-lg-12">
            ...
            <!-- /Banner Collection -->
            <section class="section-padding flat-spacing-19 wow fadeInUp box-light  our-segments">
    <div class="container">
        <div class="custom-section-title wow fadeInUp text-center" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
    ...
    <div class="container">
        <div class="custom-section-title wow fadeInUp text-center" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
            <h2><span class="theme-red-text wow fadeInUp" data-wow-delay="0s">Customize Drone Solution</span></h2>
            <p class="wow fadeInUp" data-wow-delay=".3s">
                See what our satisfied customers have to say about our electronic accessories.
            </p>
        </div>
            ...
            <div class="col-lg-7">
                <div class="dron-facilities">
                    <div class="dron-img opacity-img">
                        <a href="#">
                            <img class="img-fluid" src="imgs/customized.webp" alt="dron-img"></a>
                    </div>
                    <div class="same-facilities text-1">
                        <h4>Contract Engineering for customized UAVs, C-UAS, hardware and software
                        </h4>
                    </div>
                    <div class="same-facilities text-2">
                        <h4>Tailored solutions based on customer requirements
                        </h4>
                    </div>
                    ...
                    <div class="same-facilities text-4">
                        <h4>Repair of legacy UAV, components and payloads
                        </h4>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="swiper-wrapper cards">
                                        <div class="swiper-slide">
                                            ...
                                            <div class="blog-article-item style-row">
                                                <div class="article-thumb">
                                                    <a href="#">
                                                        <img class=" ls-is-cached lazyloaded" data-src="new/eve/1.png" src="new/eve/1.png" alt="img-blog">
                                                    </a>
                                                </div>
                                                <div class="article-content">
                                                    <div class="article-label">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 wow fadeInUp contact-us" data-wow-delay=".3s">
                            ...
                            <div class="custom-section-title mb-0 wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
                                ...
                                <a href="#" class="fade-item fade-item-3 rounded-full btn-sm tf-btn btn-fill animate-hover-btn radius-3" contenteditable="false" style="cursor: pointer;">
