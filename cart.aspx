                            ...
                            <tbody>
                                <tr class="tf-cart-item file-delete">
                                    <td class="tf-cart-item_product">
                                        <a href="#" class="img-box">
                                            <img src="imgs/pro/1.png" alt="img-product">
                                        </a>
                                        <div class="cart-info">
                                            <a href="#" class="cart-title link">Cheel</a>
                                            <span class="remove-cart link remove">Remove</span>
                                        </div>
                                    </td>
                                    <td class="tf-cart-item_price" cart-data-title="Price">
                                        <div class="cart-price">₹6,799.00</div>
                                    </td>
                                            ...
                                            <div class="wg-quantity">
                                                <span class="btn-quantity minus-btn">
                                                    <svg class="d-inline-block" width="9" height="1" viewBox="0 0 9 1" fill="currentColor">
                                                        <path d="M9 1H5.14286H3.85714H0V1.50201e-05H3.85714L5.14286 0L9 1.50201e-05V1Z"></path></svg>
                                                </span>
                                                <input type="text" name="number" value="1">
                                                <span class="btn-quantity plus-btn">
                                                    <svg class="d-inline-block" width="9" height="9" viewBox="0 0 9 9" fill="currentColor">
                                                        <path d="M9 5.14286H5.14286V9H3.85714V5.14286H0V3.85714H3.85714V0H5.14286V3.85714H9V5.14286Z"></path></svg>
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="tf-cart-item_total" cart-data-title="Total">
                                        <div class="cart-total">₹6,799.00</div>
                                    </td>
                                </tr>
                                <tr class="tf-cart-item file-delete">
                                    <td class="tf-cart-item_product">
                                        ...
                                        <div class="cart-info">
                                            <a href="#" class="cart-title link">Kavva (Indutrial Grade)</a>
                                            <span class="remove-cart link remove">Remove</span>
                                        </div>
                                    </td>
                                    <td class="tf-cart-item_price" cart-data-title="Price">
                                ...
                                <tr class="tf-cart-item file-delete">
                                    <td class="tf-cart-item_product">
                                        ...
                                        <div class="cart-info">
                                            <a href="#" class="cart-title link">Kavva (Millitary Grade)</a>
                                            <span class="remove-cart link remove">Remove</span>
                                        </div>
                                    </td>
                                    <td class="tf-cart-item_price" cart-data-title="Price">
                ...
                <div class="tf-page-cart-footer">
                    <div class="tf-cart-footer-inner">
                        ...
                        <div class="tf-page-cart-checkout">
                            ...
                            <div class="tf-cart-totals-discounts mt-0">
                                <h4>Subtotal</h4>
                                <span class="total-value fw-normal">₹20,397.00 INR</span>
                            </div>
                            <div class="tf-cart-totals-discounts mt-0">
                                <h4>Tax Amount</h4>
                                <span class="total-value fw-normal">₹0 INR</span>
                            </div>
                            <div class="tf-cart-totals-discounts">
                                <h3>Total</h3>
                                <span class="total-value">₹20,397.00 INR</span>
                            </div>
                            <p class="tf-cart-tax">
                            ...
                            <div class="cart-checkout-btn">
                                <a href="checkout.aspx" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                                    <span>Check out</span>
                                </a>
                            </div>
                            <div class="tf-page-cart_imgtrust">
                                ...
                                <div class="cart-list-social">
                                    ...
                                    <div class="payment-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-amazon"><title id="pi-amazon">Amazon</title>
