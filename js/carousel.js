...
if ($(".segment-slider").length > 0) {
    var preview = $(".segment-slider").data("preview");
    var tablet = $(".segment-slider").data("tablet");
    var mobile = $(".segment-slider").data("mobile");
    var spacingLg = $(".segment-slider").data("space-lg");
    var spacingMd = $(".segment-slider").data("space-md");
    var swiper = new Swiper(".segment-slider", {
        slidesPerView: mobile,
        spaceBetween: spacingMd,
        speed: 1000,
        pagination: {
